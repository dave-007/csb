---
title: Deploy a Serverless ASP.NET App to Azure Container Instances from Cloud Shell
published: true
description: Using Azure Cloud Shell, you will create, build and publish a .NET Core application, inside a Docker container, to Azure in a Serverless deployment model.
tags: #azure,#powershell,#cli,#docker
canonical_url: https://cloudskills.io/blog/serverless-aci-cloud-shell
series: Exploring Azure Cloud Shell
---
# Table of Contents
  ...
  - [Step 1 - Get Into Azure Cloud Shell & Editor](#step-1)
  - [Step 2 - Deploy Azure Container Registry with an ARM Template](#step-2)
  - [Step 3 - Create a .NET Core Web Application](#step-3)
  - [Step 4 - Create a Docker File](#step-4)
  - [Step 5 - Build and Push a Docker Image to Azure Container Registry](#step-5)
  - [Step 6 - Prepare to Deploy Your Docker Image as a Serverless Container](#step-6)
  - [Step 7 - Deploy Your Container, Review and Test](#step-7)
  - [Step 8 - Clean Up](#step-8)
...
![Azure Cloud Shell](https://dev-to-uploads.s3.amazonaws.com/i/o8lksnr8r1twe55anlg6.gif) **Azure Cloud Shell** is one such powerful tool. Learn Azure Cloud Shell and you unlock the full capability of the Azure cloud, with tools built in including Code Editor, Azure PowerShell and CLI, .NET Core and Docker.
...
## Step 1 - Get Into Azure Cloud Shell & Editor <a name="step-1"></a>
...
![Cloud Shell maximize/restore button](https://dev-to-uploads.s3.amazonaws.com/i/sr974thu26bpnlsj8qcr.png)
...
![cd clouddrive](https://dev-to-uploads.s3.amazonaws.com/i/cgz5chjhjporju05sl0c.gif)
...
Use the editor to paste in the content of the powershell script below **using *Shift-Insert* instead of right-click**. Customize the values, then click the ellipsis **(...)** in the upper right corner of the cloud shell editor to save, then close editor.
...
![Cloud Shell Code Editor mySettings](https://dev-to-uploads.s3.amazonaws.com/i/b2k9pd5v5dhohmvrcm3m.gif)
...
> 
> ![Restart Cloud Shell](https://dev-to-uploads.s3.amazonaws.com/i/i7854puakbscazetdl1w.png)

## Step 2 - Deploy Azure Container Registry with an ARM Template <a name="step-2"></a>
...
![result of ARM template deployment](https://dev-to-uploads.s3.amazonaws.com/i/tbjb41rhwuk2x29fmmi7.png)
...
> ![Troubleshooting ARM template deployments](https://dev-to-uploads.s3.amazonaws.com/i/gr5vpib0fu3ospl2mg0l.png)
...
![Result of `Get-AzContainerRegistry`](https://dev-to-uploads.s3.amazonaws.com/i/zo4gnkojdvl2gl9ij4s7.png)

## Step 3 - Create a .NET Core Web Application <a name="step-3"></a>
...
![docker working directory](https://dev-to-uploads.s3.amazonaws.com/i/quqy5ktj4wihdvo3pzfw.png)
...
![Results of dotnet new](https://dev-to-uploads.s3.amazonaws.com/i/gvo408z85cs64wv4mric.png)

## Step 4 - Create a Docker File <a name="step-4"></a>
...
![Using Code Editor](https://dev-to-uploads.s3.amazonaws.com/i/cr8kew4qlesevv4jcrgi.gif)
...
## Step 5 - Build and Push a Docker Image to Azure Container Registry <a name="step-5"></a>
...
![Result of az acr build](https://dev-to-uploads.s3.amazonaws.com/i/f28eyc2cne3p2y3wyqro.gif)
...
## Step 6 - Prepare to Deploy Your Docker Image as a Serverless Container <a name="step-6"></a>
...
## Step 7 - Deploy Your Container, Review and Test <a name="step-7"></a>
...
![Inspect ACG Object](https://dev-to-uploads.s3.amazonaws.com/i/i0wy97nnk86nh0hkierp.png)
...
![Browse WebApp](https://dev-to-uploads.s3.amazonaws.com/i/496pwwrslwbx4z3vl7wr.png)
...
## Step 8 - Clean Up <a name="step-8"></a>
...
If you try to use the code editor to save files in this starting location of `Azure:\`, you will get an error. Instead, type `cd ~\clouddrive` (that starts with the tilde character (~) at the top left of your keyboard, a symbol for your home directory) to navigate to your clouddrive, and type `pwd` (an alias of `Get-ChildItem`) to see your current location in the drive.
